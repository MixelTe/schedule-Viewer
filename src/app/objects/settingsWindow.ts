...
export class SettingsWindow extends DialogWindow
{
	...
	constructor(parent: HTMLElement, data: ScheduleOptionsFull)
	{
		...
		this.table.appendChild(this.createRow(rowStyle, [
			this.createCell(1, "", cellStyle, this.createOption("revTimeInput", "scheduleViewer-SettingsWindow-revTimeInput", false, 0)),
			this.createCell(1, "", cellStyle, this.createOption("showRealLineAfterEnd", "scheduleViewer-SettingsWindow-showRealLineAfterEnd", false, 1)),
		]));
		this.table.appendChild(this.createRow(rowStyle, [
			this.createCell(1, "", cellStyle, this.createOption("compactLinePlacing", "scheduleViewer-SettingsWindow-compactLinePlacing", false, 2)),
			this.createCell(1, "", cellStyle, this.createOption("compactPlacingAlignIsTop", "scheduleViewer-SettingsWindow-compactPlacingAlignIsTop", false, 3)),
		]));
		this.table.appendChild(this.createRow(rowStyle, [
			this.createCell(1, "", cellStyle, this.createOption("selectionCustomColor", "scheduleViewer-SettingsWindow-selectionCustomColor", false, 4)),
			this.createCell(1, "", cellStyle, this.createOption("showSeparateLine", "scheduleViewer-SettingsWindow-showSeparateLine", false, 5)),
		]));
		this.table.appendChild(this.createRow(rowStyle, [
			this.createCell(1, "", cellStyle, this.createOption("showYAxis", "scheduleViewer-SettingsWindow-showYAxis", false, 6)),
		]));
		this.table.appendChild(this.createRow(rowStyle, [
